...
population <- function(N, T, mean_life = MEAN_LIFE, drop_rate = DROP_RATE, mean_stay = MEAN_STAY){
  # Simulate occupancy history of the area
  history <- queue(N, mean_stay, T)$individuals
  N_tot <- dim(history)[1]
